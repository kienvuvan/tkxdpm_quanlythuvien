...
import static user.dao.MysqlAccountDao.ACCOUNT_FALSE;
import static user.dao.MysqlAccountDao.CHANGE_PASS_SUCCESS;
import static user.dao.MysqlAccountDao.FAILE_SYSTEM;
import static user.dao.MysqlAccountDao.LOGIN_FAIL;
import static user.dao.MysqlAccountDao.LOGIN_WITH_LIBRARIAN;
import static user.dao.MysqlAccountDao.PASSAGAIN_NOT_SAME_PASSNEW;
